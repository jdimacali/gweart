...
const SlideShow = ({ slides }: SlideShowProps) => {
  return (
    <section className="w-full h-full text-white bg-zinc-950 flex flex-col items-center py-20 gap-y-10 bg-[url('/background/pumpkin.png')] bg-cover bg-no-repeat overflow-hidden">
      <motion.div
