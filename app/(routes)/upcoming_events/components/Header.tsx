const Header = () => {
  return (
    <div className="flex flex-col text-center items-center justify-center relative space-y-8 z-1">
      <h3 className="flex gap-x-6 lg:text-[4rem] sm:text-[3rem] max-sm:text-lg font-dokdo">
        <div>
      ...
      <h1
        className={`flex xl:text-[6rem] md:text-[4rem] sm:text-[3.5rem] text-lg font-creep text-amber-100`}
      >
